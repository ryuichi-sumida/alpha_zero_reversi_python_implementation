...
class GameUI(tk.Frame):
    ...
    def turn_of_human(self, event):
        ...
        if self.state.is_done():
            if self.state.is_lose():
                self.c.create_text(1100, 500, text="LOSE", fill="blue", font=FL)
            elif self.state.is_draw():
                self.c.create_text(1100, 500, text="draw....", fill="silver", font=FL)
            else:
                self.c.create_text(1100, 500, text="WIN!!", fill="red", font=FL)
    ...
    def draw_a_dot(self,index,first_player):
        ...
        y = int(index/8)*100+10
        if first_player:
            self.c.create_oval(x+35, y+35, x+45, y+45, width = 1.0, outline = '#000000', fill = "blue")
        else:
            self.c.create_oval(x+35, y+35, x+45, y+45, width = 1.0, outline = '#000000', fill = "blue")
